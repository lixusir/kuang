...
class Configure_EweiShopV2Page extends PluginWebPage {
    ...
    private $message = array(
        ...
        'logo' => '请上传分享图标',
        'describe' => '请填写分享描述',
        'public_qrcode' => '请上传公众号二维码',
        'force_follow' => '请选择是否强制关注',
    );
    /**
     * 需要验证是否非空的字段以及其回复
     * @var array
    ...
    public function setReplyKeywordRule($configure) {
        ...
        $replyData = array(
            ...
            'description' => $configure['describe'],
            'thumb' => $configure['logo'],
            'url' => $configure['url'],
        );
        // 设置回复信息
    ...
    public function getRule() {
        ...
        $data = array(
            'uniacid' => $_W['uniacid'],
            'name' => 'ewei_shopv2:open:open_farm',
            'module' => 'ewei_shopv2',
            'status' => '1',
        );
