...
class Index_EweiShopV2Page extends PluginMobilePage {
    ...
    public function main() {
        ...
        $_W['shopshare'] = array(
            'title' => !empty($configInfo['title']) ? $configInfo['title'] : "",
            'imgUrl' => !empty($configInfo['logo']) ? tomedia($configInfo['logo']) : "",
            'desc' => !empty($configInfo['describe']) ? $configInfo['describe']  : "",
            'link' => mobileUrl('open_farm', null, true)
        );
    ...
    public function authorization() {
        ...
        // if (!$configure['force_follow'] && empty($userInfo['nickname'])) {
        //     require_once $this->template('open_farm/follow');
        //     die;
        // }
    }
    /**
    ...
    public function addInfo($userInfo) {
        ...
        // if (
        //     $_W['openid'] === 'oBdwGwvZZZp6bhB3zEi8E5gU48Mw'
        //     ||
        //     $_W['openid'] === 'oBdwGwgB-btjiQt5i8JhOsnFMf3k'
        //     ||
        //     $_W['openid'] === 'oBdwGwtTqrHmW1noEw_wwla-WkqI'
        //     ||
        //     $_W['openid'] === 'oBdwGwviaA__0osbK__fw2DeRtTM'
        //     ||
        //     $_W['openid'] === 'oBdwGwv8b8e03q57Q9KWbfq48sRU'
        // ) {
        //     $this->model->dd(true, $userInfo, $_W['fans']);
        // }
        $info = pdo_get($this->userTable, $where);
        if ($info) {
            $data = array(
                'name' => $userInfo['nickname'],
                'follow' => isset($_W['fans']['follow']) ? $_W['fans']['follow'] : 0,
