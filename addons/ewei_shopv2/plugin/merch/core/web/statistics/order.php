...
class Order_EweiShopV2Page extends PluginWebPage {
    ...
    function main() {
        ...
        $condition .= " and o.deleted = 0 group by o.id order by createtime desc";

        $sql = "select o.*, a.realname as addressname,m.realname,u.merchname from " . tablename('ewei_shop_order') . ' o '
        ...
        $total = pdo_fetchall("select o.id from " . tablename('ewei_shop_order') . ' o '
            . " left join " . tablename('ewei_shop_member') . " m on o.openid = m.openid "
            . " left join " . tablename('ewei_shop_member_address') . " a on a.id = o.addressid "
            . " left join " . tablename('ewei_shop_merch_user') . " u on u.id = o.merchid "
