...
class Credit_EweiShopV2Page extends MerchWebPage {
    ...
    protected  function applyData($status, $st){
        ...
        $sql = "select b.*,u.merchname,u.realname,u.mobile,u.iscreditmoney,b.creditrate,b.isbillcredit from " . tablename('ewei_shop_merch_bill') . " b "
...
//        $creditrate = $iscreditmoneys[0]['creditrate'];
