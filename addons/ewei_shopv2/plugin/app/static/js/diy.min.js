define(['jquery.ui', '../../../../static/js/web/goods_selector.js','/../../../addons/ewei_shopv2/plugin/app/static/js/drag.js?V=' +  (new Date()).valueOf()], function (ui, gSelector,Drag) {
    ...
    modal.initNavs = function () {
        modal.setNavs();
        var navgroup = {
            0: ['listmenu', 'richtext', 'title', 'line', 'blank', 'menu', 'menu2', 'picture', 'banner', 'picturew', 'coupon','tabbar','topmenu','hotarea'],
            2: ['notice', 'goods', 'search', 'fixedsearch','seckillgroup', 'copyright', 'video', 'groupsgoods','merchgroup','shortVideo'],
            20:['notice', 'goods', 'search', 'fixedsearch', 'pictures','icongroup', 'audio', 'copyright', 'video', 'groupsgoods',,'shortVideo'],
            /*会员中心 @author 青椒 @date 2018/2/10*/
            3: ['member' ,'bindmobile' ,  'notice','verify','pictures','icongroup','audio','copyright','shortVideo'],
            /*商品详情 @author 青椒 @date 2018/2/26*/
            4: ['detail_swipe','detail_seckill','detail_info','detail_sale','detail_spec','detail_package','detail_shop','detail_buyshow','detail_navbar','pictures','icongroup','audio','goods','copyright', 'groupsgoods','detailVideo'],
            /*整点秒杀 @author 牟俊羽 @date 2018/4/09*/
            5: ['seckill_times','seckill_rooms','seckill_advs','seckill_list','audio','icongroup','pictures','shortVideo'],
        };
    ...
    modal.setNavs = function () {
        modal.navs = {
            ...
            hotarea: {
                name: '热区',
                params: {
                    bgimg: '../addons/ewei_shopv2/plugin/app/static/images/default/cube-1.jpg',
                },
                style: {
                    'paddingtop': '10',
                    'paddingleft': '10',
    ...
    $(document).on('click','.addHotarea',function() {
        ...
        if(close >0) {
            if($(this).parent().hasClass('item-image') || $(this).hasClass('btn-w-m') ) {
                ...
                for (var i=0;i<cont.length;i++) {
                    ...
                    console.log(h,t,'aaaaaaaaaaaaaaaaa');
        ...
        var obj = $('<div class="draggable dragable-item" data-ischeck="false" style="z-index:' + index+'; position:absolute;top: 10px;left: 10px; user-select: auto;width: 100px;height: 100px;">' +
            ...
            +'<div class="handle rLeftDown" style="bottom: -5px;left: -5px;"></div>'
            +'<div class="handle rLeft"  style="left: -5px;top: calc(50% - 4px);"></div>'
            +'<div class="addUrl" data-toggle="selectUrl" data-platform="wxapp" data-input="'+curl+'">选择链接</div>'
            +'<span class="delHot" >×</span></div>');
