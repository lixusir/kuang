...
class Index_EweiShopV2Page extends AppMobilePage {
    ...
    function main() {
        ...
        if(is_array($page['data']['page']) && !empty($page['data']['page']['diyadv'])){
            $startadvitem = pdo_fetch('SELECT * FROM '. tablename('ewei_shop_wxapp_startadv'). ' WHERE id=:id AND uniacid=:uniacid', array(
