...
(55,58,'goodshelper','tool','新商品助手','1.0','官方',1,'../addons/ewei_shopv2/static/images/goodshelper.png', '', 0, 0, 0),
(56,59,'touch_loop','tool','一键发圈','1.0','官方',1,'../addons/ewei_shopv2/static/images/touch_loop.png', '', 0, 0, 0);
...
$list = pdo_fetch(" SELECT * FROM ".tablename('ewei_shop_exhelper_esheet')." WHERE code=:code",array(':code'=>'STO'));

        if (!empty($list)){
            $data['datas'] = 'a:3:{i:0;a:4:{s:5:"style";s:9:"一联130";s:4:"spec";s:18:"(宽100mm高130mm)";s:4:"size";s:3:"130";s:9:"isdefault";i:0;}i:1;a:4:{s:5:"style";s:9:"二联180";s:4:"spec";s:30:"(宽100mm高180mm切点110/70)";s:4:"size";s:3:"180";s:9:"isdefault";i:1;}i:2;a:4:{s:5:"style";s:9:"二联150";s:4:"spec";s:31:"(宽100mm 高150mm 切点90/60)";s:4:"size";s:3:"150";s:9:"isdefault";i:0;}}';
            
            $upd = pdo_update('ewei_shop_exhelper_esheet',$data,array('id'=>$list['id']));
        }
...
$mes = pdo_fetch(" SELECT * FROM".tablename('ewei_shop_member_message_template_type')." WHERE typecode='willcancelverify'" );

        if (empty($mes)){
            $data = array(
                'id'=>93,
                'name'=>'核销商品到期通知',
                'typecode'=>'willcancelverify',
                'templatecode'=>'OPENTM414420948',
                'templatename'=>'订单关闭提醒',
                'content'=>'{{first.DATA}}商品提货商品：{{keyword1.DATA}}到期时间：{{keyword2.DATA}}{{remark.DATA}}',
                'typegroup'=>'sys',
                'groupname'=>'系统消息通知',
                'showtotaladd'=>0
            ...
            pdo_insert('ewei_shop_member_message_template_type',$data);
        }

$mes = pdo_fetch(" SELECT * FROM".tablename('ewei_shop_exhelper_esheet')." WHERE code='HTKY'" );

        if (!empty($mes)){
            $data = array(
                'datas'=> 'a:2:{i:0;a:4:{s:5:"style";s:9:"二联183";s:4:"spec";s:37:"（宽100mm 高183mm 切点87/5/91）";s:4:"size";s:3:"183";s:9:"isdefault";i:1;}i:1;a:4:{s:5:"style";s:6:"一联";s:4:"spec";s:30:"(宽100mm高180mm切点110/70)";s:4:"size";s:3:"130";s:9:"isdefault";i:0;}}'
            );

            pdo_update('ewei_shop_exhelper_esheet',$data,array('id'=>$mes['id']));
        }

$mes = pdo_fetch(" SELECT * FROM".tablename('ewei_shop_exhelper_esheet')." WHERE code='YTO'" );

        if (!empty($mes)){
            $data = array(
                'datas' => 'a:2:{i:0;a:4:{s:5:"style";s:9:"二联180";s:4:"spec";s:34:"（宽100mm高180mm切点110/70）";s:4:"size";s:5:"18001";s:9:"isdefault";i:0;}i:1;a:4:{s:5:"style";s:9:"一联130";s:4:"spec";s:17:"(宽76mm高130mm)";s:4:"size";s:3:"130";s:9:"isdefault";i:0;}}'
            );
...
@unlink( IA_ROOT.'/addons/ewei_shopv2/core/web/system/auth/index1.php');
@unlink( IA_ROOT.'/addons/ewei_shopv2/plugin/wxlive/core/form.php');
