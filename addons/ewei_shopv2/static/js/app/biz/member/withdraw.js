...
// console.log(checked_applytype);
        ...
        $('#btn-next').click(function () {
            ...
            if (applytype == 0) {
                ...
                html = typename + "?<br>姓名:" + realname + "<br>" + bankname + "<br>"+ " 开户行:" + openbank + "<br>" + " 卡号:" + $('#bankcard').val();
            }
            ...
            FoxUI.confirm(confirm_msg, function () {
                ...
                core.json('member/withdraw/submit', {applytype: applytype, realname: realname, alipay: alipay, alipay1: alipay1, bankname: bankname,openbank:openbank, bankcard: bankcard, bankcard1: bankcard1, money: money}, function (rjson) {
                    if (rjson.status != 1) {
