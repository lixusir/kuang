...
//        print_r($refund);die();
        ...
        $goodsid_array =array();
        $goods = pdo_fetchall("select og.rstate,og.id,og.single_refundstate,og.sendtime,og.goodsid,og.price,g.title,og.title as gtitle,g.thumb,g.status, g.cannotrefund, og.total,g.credit,og.optionid,
