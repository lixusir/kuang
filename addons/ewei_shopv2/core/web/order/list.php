        ...
        if($order_type !== ''){
            ...
            if($order_type == 'general'){
                if(in_array($searchfield,array('goodstitle','goodssn','goodsoptiontitle'))){
                    //下文已经联查ewei_shop_order_goods 表
                    $fullback_where = ' and og.fullbackid=0';
                }else{
                    //此时需要联查ewei_shop_order_goods 表
            ...
            if($searchfield == 'member') {
                ...
                $sql = "select  o.* ,m.groupid,a.realname as arealname,o.merchdeductenough,a.mobile as amobile,a.province as aprovince ,a.city as acity , a.area as aarea, a.street as astreet,a.address as aaddress,
                  r.rtype,r.status as rstatus,o.sendtype,o.city_express_state from " . tablename('ewei_shop_order') . " o"
                    . " left join " . tablename('ewei_shop_order_refund') . " r on r.id =o.refundid "
                    . " left join "  . tablename('ewei_shop_member') . " m on m.openid=o.openid and m.uniacid =  o.uniacid "
                    . " left join " . tablename('ewei_shop_member_address') . " a on a.id=o.addressid " . " $sqlcondition where $condition $statuscondition ORDER BY $orderbuy DESC  ";
            }
