!function (c) {
    ...
    e.prototype = {
        constructor: e, _events: [], _attachEvents: function () {
            ...
            var B = new Date(this.viewDate), o = B.getUTCFullYear(), C = B.getUTCMonth(), h = B.getUTCDate(),
                x = B.getUTCHours(), s = B.getUTCMinutes(),
            ...
            this.updateNavArrows();
            this.fillMonths();
            var E = f(o, C - 1, 28, 0, 0, 0, 0), w = b.getDaysInMonth(E.getUTCFullYear(), E.getUTCMonth());
            E.setUTCDate(w);
