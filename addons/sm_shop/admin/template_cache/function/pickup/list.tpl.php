        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="<?php echo $this->url_pre . '&r=pickup.page_edit';?>"
                       data-toggle="tooltip" title="" class="btn btn-primary"
                       data-original-title="添加">
                        <i class="fa fa-plus"></i>
                    </a>
                    <a href="<?php echo $this->url_pre . '&r=pickup.page_list';?>"
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-9 col-md-pull-3 col-sm-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-list"></i> 自提点列表 </h3>
                        </div>
                        <div class="panel-body">
    ...
    var vue = new Vue({
        ...
        methods:{
            ...
            get_list:function(){
                ...
                var url = this.url_pre + '&r=pickup.index';
                if( this.filter.name ){
            ...
            pickup_remove : function( pickup ){

                var t = this;

                var url = this.url_pre + '&r=pickup.remove';

                var data = 'id=' + pickup.id;
