    ...
    <div id="content">
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    ...
                    <a  data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="添加"><i class="fa fa-plus"></i></a>
                    -->
                    </div>
        ...
        <div class="container-fluid">
            ...
            <div id="filter-order" class="col-md-3 col-md-push-9 col-sm-12 hidden-sm hidden-xs">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="input-customer">昵称</label>
                        ...
                        <div class="form-group hide">
                            <label class="control-label" for="input-order-status">用户组</label>
            ...
            <div class="col-md-9 col-md-pull-3 col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-list"></i> 客户列表</h3>
                    </div>
                    <div class="panel-body">
...
<!--                                        </td>-->
                                    ...
                                    >
                                        ...
                                        <td class="text-right">
                                            <img style="width:50px; border-radius: 10px" v-bind:src="item.headUrl" alt="" />
                                        </td>
                                        <td class="text-right">
                                            {{item.name}}
                                            <span class="wxapp"
                                                  style="font-size: 12px; display: block; color: #ccc;"
                                                  v-show="item.xcx_open_id" >(小程序)</span>
                                        </td>
                                        <td class="text-right">{{item.telephone}}</td>
                                        <td class="text-right">{{item.customer_group}}</td>
                                        <td class="text-right">{{item.create_time}}</td>
<!--                                        <td class="text-right">{{item.create_time}}</td>-->
                                        <td class="text-right">
                                            <a v-bind:href=" url_pre + '&r=customer.page_edit&id=' + item.id "
    ...
    var vue = new Vue({
        ...
        methods:{
            ...
            get_list:function(){
                ...
                var t = this;
                var url = this.url_pre + '&r=customer.index';
                ...
                if( this.filter.telephone != '' ){
                    url += '&telephone=' + this.filter.telephone;
                }
