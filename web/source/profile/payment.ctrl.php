...
if ('change_status' == $do) {
	...
	if ('jueqiymf' == $type) {
		$pay_setting[$type]['has_status'] = $param['has_status'];
	}
...
if ('display' == $do || 'switch' == $do) {
	...
	$pay_setting = payment_setting();
	$pay_setting['wechat']['borrow'] = empty($pay_setting['wechat']['borrow']) ? '' : (string)$pay_setting['wechat']['borrow'];
	$pay_setting['wechat']['service'] = empty($pay_setting['wechat']['service']) ? '' : (string)$pay_setting['wechat']['service'];
